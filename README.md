...
> تمام تصاویر به‌صورت محلی در پوشه‌ی `public/` نگه‌داری می‌شوند (به‌دلیل فیلتر بودن Unsplash در ایران) و نیازی به اینترنت خارجی برای نمایش‌شان نیست. بک‌اندی وجود ندارد.
