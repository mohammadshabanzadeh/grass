 ...
 * Description: نوع پست «پروژه» را برای مدیریت نمونه‌کارهای سایت اضافه می‌کند (شهر، دسته‌بندی، کاربری، متراژ، گالری تصاویر) و آن را از طریق REST API در اختیار سایت React قرار می‌دهد. همچنین یک مسیر عمومی برای خواندن فهرست (منو) سایت فراهم می‌کند.
 * Version: 1.1.0
 * Author: Faraz Chaman
